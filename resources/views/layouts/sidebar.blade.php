...
{{--            <li class="nav-item"><a ><i class="la la-group"></i>--}}
...
{{--                    --}}{{--Start Add Main Category--}}
{{--                    <li class="active">--}}
{{--                        <a class="menu-item" data-i18n="nav.dash.ecommerce">--}}
...
{{--                    --}}{{--                    </li>--}}
{{--                    <li><a class="menu-item" data-i18n="nav.dash.crypto">{{__('admin/index.Add Product')}}</a>--}}
{{--                    <li><a class="menu-item"  data-i18n="nav.dash.crypto">{{__('admin/index.Products')}}</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </li>--}}
{{--            --}}{{--End Product--}}
